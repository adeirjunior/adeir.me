  ...
  return (
    <div class="mb-4 w-full bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600">
        <div class="flex justify-between items-center py-2 px-3 border-b dark:border-gray-600">
            ...
            <button type="button" data-tooltip-target="tooltip-fullscreen" class="p-2 focus:outline-none text-gray-500 rounded cursor-pointer sm:ml-auto hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
        ...
        <div class="py-2 px-4 bg-white rounded-b-lg dark:bg-gray-800">
            ...
            {...props} 
            rows={8} 
            class="block outline-none px-0 w-full max-h-80 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" 
            ></textarea>
        </div>
    </div>
  )
