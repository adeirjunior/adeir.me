    ...
    <div className="w-full">
      <div className="h-full bg-gray-200 dark:bg-gray-800 bg-opacity-40 px-8 pt-8 pb-24 rounded-lg overflow-hidden text-center relative">
        ...
        <div className="text-center mt-2 leading-none flex justify-center absolute bottom-0 left-0 w-full py-4">
          <a href={host} target={host} className="group text-gray-500 mr-3 inline-flex items-center leading-none text-sm pr-3 py-1 border-r-2 border-gray-700 border-opacity-50">
            <CgWebsite className="group-hover:scale-110 w-[20px] h-[20px] sm:w-[24px] sm:h-[24px]" />
          </a>
          <a href={repository} target={repository} className="group text-gray-500 inline-flex items-center leading-none text-sm">
